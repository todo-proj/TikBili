...
package com.benyq.tikbili.player.helper;
...
public class DisplayModeHelper {
    ...
    private void applyDisplayMode() {
        ...
        if (displayLP.height != displayHeight
            ...
            Log.i(this.getClass().getSimpleName(), String.format("applyDisplayMode %d, %d, %d", displayLP.gravity, displayLP.width, displayLP.height));
